    ...
    <div className="h-[calc(100vh-7rem)] flex flex-col">
      ...
      <Modal isOpen={formOpen} onClose={() => setFormOpen(false)} title="Add Relationship" size="md">
        <form onSubmit={handleSubmitRel} className="space-y-4">
          ...
          <FormSelect label="Relationship Type" options={sourceTypeOptions} value={form.relationship_type} onChange={(e) => setForm({ ...form, relationship_type: e.target.value })} required />
